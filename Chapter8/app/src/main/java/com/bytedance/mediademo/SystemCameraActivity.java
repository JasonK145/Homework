...
public class SystemCameraActivity extends AppCompatActivity {
    ...
    private int REQUEST_CODE_RECORD = 1000;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            int targerHeight = imageView.getHeight();
            ...
            int scaleFactor = Math.min(photoWidth/targetWidth,photoHeight/targerHeight);
    ...
    private Bitmap rotateImage(Bitmap bitmap,String path){
        try{
            ...
            int angle = 0;
            int orientataion = srcExif.getAttributeInt(ExifInterface.TAG_ORIENTATION,ExifInterface.ORIENTATION_NORMAL);
            switch(orientataion){
